...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required=True,
        help="Relative path to diffusion checkpoint path",
    )
    args = parser.parse_args()

    path_out = Path("results") / "BTXRD" / "samples"
    ...
    #     "./runs/diffusion_2025_11_26_185034/last.ckpt"
    # )
    pipeline = DiffusionPipeline.load_from_checkpoint(args.diffusion_checkpoint_path)
    pipeline.to(device)
